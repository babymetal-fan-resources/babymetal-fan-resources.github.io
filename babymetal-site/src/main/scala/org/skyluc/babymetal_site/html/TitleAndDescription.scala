...
object TitleAndDescription {
  ...
  val TITLE_SUFFIX_1 = " - BABYMETAL"
  val TITLE_SUFFIX_12 = TITLE_SUFFIX_1 + " - BABYMETAL Fan Resources."
  ...
  val DESCRIPTION_SUFFIX_3 = " Resources around BABYMETAL."
  val DESCRIPTION_SUFFIX_13 = TITLE_SUFFIX_1 + DESCRIPTION_SUFFIX_3
  val DESCRIPTION_SUFFIX_123 = TITLE_SUFFIX_12 + DESCRIPTION_SUFFIX_3
